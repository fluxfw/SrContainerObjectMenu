...
```php
\srag\DIC\SrContainerObjectMenu\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrContainerObjectMenu\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrContainerObjectMenu\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
