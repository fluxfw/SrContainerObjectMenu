...
```php
use srag\DIC\SrContainerObjectMenu\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrContainerObjectMenu\x\Version\PluginVersionParameter;
...
