...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectMenu\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectMenu\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrContainerObjectMenu\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectMenu\x\UpdateVersion; 
...
