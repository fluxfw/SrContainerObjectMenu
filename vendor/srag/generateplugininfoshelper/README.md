...
```json
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\SrContainerObjectMenu\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrContainerObjectMenu\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrContainerObjectMenu\\x\\UpdatePluginReadme::updatePluginReadme"
    ]
```
