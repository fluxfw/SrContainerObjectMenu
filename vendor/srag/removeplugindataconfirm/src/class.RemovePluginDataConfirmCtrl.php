...
use ilSession;
use ilUtil;
use srag\DIC\SrContainerObjectMenu\DICStatic;
 ...
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\SrContainerObjectMenu\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
