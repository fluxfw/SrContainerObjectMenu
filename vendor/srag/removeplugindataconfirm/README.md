...
```php
//...
use srag\RemovePluginDataConfirm\SrContainerObjectMenu\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrContainerObjectMenu\x\RepositoryObjectPluginUninstallTrait;
//...
